...
Optimizado para Infraestructura OVH (16 vCores)
...
Modo Relay Pure: Configurado para reenvío directo (pass-through) al servidor HLS externo 37.59.97.144.
...
🔒 Flujo de Seguridad
Streamer: Envía señal a rtmp://TU_IP/live/clave_secreta.

Backend Go: Valida la clave y busca el UUID en Supabase.

FFmpeg: Captura un frame cada 10s y lo guarda como hash_md5(uuid).jpg.

Frontend: Muestra la imagen pública sin revelar la clave de transmisión.
